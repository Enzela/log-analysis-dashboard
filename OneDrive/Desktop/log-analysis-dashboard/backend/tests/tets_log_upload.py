...
# ✅ Test 1: Upload endpoint kaam garxa ki xaina
def test_upload_endpoint_exists():
    response = client.get("/")
    assert response.status_code == 200

# ✅ Test 2: JSON log file upload test
...
# ✅ Test 3: AI detector — 5 dummy log entries severity check
...
# ✅ Test 4: Upload returns results with correct fields
def test_upload_returns_results():
    log_data = [
        {"timestamp": "2026-06-20 10:15:23", "ip": "192.168.1.10", "event": "login_success", "message": "User logged in"},
    ]
    file_content = json.dumps(log_data).encode("utf-8")
...
# ✅ Test 5: 5 dummy data — sabai detect vayo ki xaina
